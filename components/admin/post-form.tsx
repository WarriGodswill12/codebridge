  ...
  return (
    <form action={action} className="flex flex-col gap-8">
      ...
      <div className="border-b border-border pb-8">
        <h2 className="mb-5 font-display text-lg italic">Basics</h2>
        ...
        <div className="mt-6 flex flex-col gap-2 sm:w-48">
      ...
      <div>
        <h2 className="mb-5 font-display text-lg italic">Body</h2>
        <div className="flex flex-col gap-2">
          <Label htmlFor="body">Content</Label>
          <p className="text-xs text-muted-foreground">
            One block per paragraph, separated by a blank line. <code>{"# Heading"}</code> for a
            heading, <code>{"- item"}</code> lines for a bulleted list, and{" "}
            <code>{"| cell | cell"}</code> lines for a table (first line is the header row).
          </p>
          <Textarea
            id="body"
            name="body"
